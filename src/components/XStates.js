...
const XStates = () => {
    ...
    return(
        ...
        {cityName? (<span>
                <span className="introTxt inline-content">You selected </span>
                <span className="cityName inline-content">{cityName}, </span>
                <span className="stateCtry inline-content">{stateName}, {countryName}</span>
                </span>)
            :null}
        </>
    )
